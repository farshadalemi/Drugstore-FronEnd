...
import ProductImage from "../../Images/DrugstoreImages/hairloss.jpg";
...
const FeaturedProductsHairLoss: React.FC = () => {
  return (
    <MDBCard>
      ...
      <MDBCardBody className="text-center">
        <MDBCardTitle>Hair Loss</MDBCardTitle>
        <MDBCardText>
...
export default FeaturedProductsHairLoss;