...
import ProductImage from "../../Images/DrugstoreImages/Acne.jpg";
...
const FeaturedProductsAcne: React.FC = () => {
  return (
    <MDBCard>
      ...
      <MDBCardBody className="text-center">
        <MDBCardTitle>Acne</MDBCardTitle>
        <MDBCardText>
...
export default FeaturedProductsAcne;